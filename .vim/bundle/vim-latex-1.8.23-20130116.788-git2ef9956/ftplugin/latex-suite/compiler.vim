...
function! Tex_CompileLatex()
	if &ft != 'tex'
		echo &ft "calling Tex_RunLaTeX from a non-tex file93"
		return
	end
...
function! Tex_ViewLaTeX()
	if &ft != 'tex'
		echo &ft " calling Tex_ViewLaTeX from a non-tex file223"
		return
	end
...
function! Tex_ForwardSearchLaTeX()
	if &ft != 'tex'
		echo "calling Tex_ForwardSeachLaTeX from a non-tex fileSB"
		return
	end
